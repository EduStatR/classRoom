...
| **Outros assuntos** | Cálculo da razão de chances (*odds ratio*) e do risco relativo, com intervalo de confiança. Realização do teste *post hoc* de Scheffé para comparação múltipla de médias. |

**Fonte:** Bittencourt et. al (2025).
